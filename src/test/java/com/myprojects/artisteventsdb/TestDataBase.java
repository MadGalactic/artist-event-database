...
public class TestDataBase extends AbstractTest{
    ...
    public void testDbConnectionProperties () throws IOException {
        ...
        Pattern urlPattern = Pattern.compile("spring.datasource.url=jdbc:mysql://localhost:3306/artist-events-db");
        ...
        Pattern usernamePattern = Pattern.compile("spring.datasource.username=artist-events-db");
        ...
        Pattern passwordPattern = Pattern.compile("spring.datasource.password=Fox-Deer-Cat");
